            ...
            if (! $.csv) {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        // Convert data
			var options={"separator" : $.fn.jexcel.defaults[id].delimiter || ','};
/////////////modification JEREMY TOURNAYRE
                       // var data = $.csv.toArrays(result);	
                        var data = $.csv.toArrays(result,options);
//////////////////////FIN MODIFICATION
                        // Headers
    ...
    parseCSV : function(CSV_string, delimiter)
    {
		...
		////////////////////////FIN Modification JEREMY TOURNAYRE
              }
            }
            var matched_value;
    ...
    download : function () {
	  ...
	  ////////////////////////Modification JEREMY TOURNAYRE
	    ...
	    window.navigator.msSaveOrOpenBlob(blob, options.csvFileName);
	    ////////////////////////FIN Modification JEREMY TOURNAYRE
        } else {
	    ...
	    pom.setAttribute('download', options.csvFileName);
	    ////////////////////////FIN Modification JEREMY TOURNAYRE
